...
function MakeImageManager(){
	...
	this.write_menu_pxe = function (name,hdd,finaloperations,testdisks,pathfiles){
		
		$.xmlrpc({
				url: 'https://'+sessionStorage.server+':9779',
				methodName: 'write_menu_pxe',
				params: [[sessionStorage.username , sessionStorage.password],"OpenSysClone",'SaveImage.tpl',pathfiles,name,hdd,finaloperations,testdisks],
				success: function(response,status,jqXHR){
